...
(function () {
    ...
    fin.desktop.System = {
        ...
        terminateExternalProcess: function(processUuid, timeout, callback, errorCallback) {
    ...
    fin.desktop.Window.prototype = {
        ...
        disableWindowFrame: function (callback, errorCallback) {
            sendMessageToDesktop('disable-window-frame', {
                uuid: this.app_uuid,
                name: this.name
            }, callback, errorCallback);
        },
        enableWindowFrame: function (callback, errorCallback) {
